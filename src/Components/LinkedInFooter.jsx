    ...
    return (
      <Container id="FOOOOOOOOOTer">
        ...
        <Row>
          ...
          <Col xs={4}><DropdownButton id="language-button" title="English (English)" >
  
  <Dropdown.Item id="language-button" as="button">English</Dropdown.Item>
  <Dropdown.Item  id="language-button" as="button">Another One</Dropdown.Item>
  <Dropdown.Item id="language-button" as="button">Another One</Dropdown.Item>
  <Dropdown.Item  id="language-button" as="button">Another One</Dropdown.Item>
  <Dropdown.Item id="language-button" as="button">Another One</Dropdown.Item>
  <Dropdown.Item  id="language-button" as="button">Another One</Dropdown.Item>
